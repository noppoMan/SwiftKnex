...
sleep 4
sudo mysql -e "create database swift_knex_test; use mysql; update user set authentication_string=PASSWORD('') where user='root'; update user set plugin='mysql_native_password'; FLUSH PRIVILEGES;"
